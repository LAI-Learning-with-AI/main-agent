# From https://github.com/gustavz/DataChad/blob/main/datachad/backend/loader.py
...
def split_docs(docs: list[Document], store_type: str, options: dict) -> list[Document]:
    if False: #store_type == STORES.SMART_FAQ:
        text_splitter = SmartFAQSplitter()
    else:
        #tokenizer = get_tokenizer(options)
        tokenizer = tiktoken.encoding_for_model("gpt-3.5-turbo")  # "cl100k_base"
